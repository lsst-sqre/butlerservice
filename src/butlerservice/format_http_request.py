...
def format_http_request(
    ...
    Example of use::
        ...
        from src.butlerservice.format_http_request import format_http_request

        url = "http://localhost:8000/butlerservice"
