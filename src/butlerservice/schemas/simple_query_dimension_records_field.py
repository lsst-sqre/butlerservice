...
__all__ = ["simple_query_dimension_records_field"]

import graphql

from butlerservice.resolvers.simple_query_dimension_records import (
    simple_query_dimension_records,
)
from butlerservice.schemas.simple_record_type import SimpleRecordType

simple_query_dimension_records_field = graphql.GraphQLField(
    graphql.GraphQLList(SimpleRecordType),
    args=dict(
        element=graphql.GraphQLArgument(
            graphql.GraphQLNonNull(graphql.GraphQLString),
            description="The dimension element to obtain, e.g. 'exposure'.",
        ),
    ...
    resolve=simple_query_dimension_records,
