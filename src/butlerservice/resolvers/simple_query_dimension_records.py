...
def encode_record_dict(raw_dict):
...
async def simple_query_dimension_records(
    ...
    element: str,
    dataid: str or None = None,
    datasets: list or None = None,
    datasetregexs: list or None = None,
    collections: list or None = None,
    collectionregexs: list or None = None,
    where: str or None = None,
    components: bool or None = None,
    bind: dict = None,
    check: bool = True,
    kwargs: str or None = None,
) -> typing.List[dict]:
